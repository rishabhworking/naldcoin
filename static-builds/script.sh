...
find ${DISTNAME}/bin -type f -executable -exec ../naldcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../naldcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/naldcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/naldcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
