...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Naldcoin Core developers\n",
    "The Naldcoin Core developers \n",
    "Naldcoin Core Developers\n",
    "the Naldcoin Core developers\n",
    "The Naldcoin developers\n",
    "BitPay Inc\.\n",
    "BitPay, Inc\.\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Naldcoin Core developers'
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Naldcoin 
