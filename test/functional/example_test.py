...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NaldcoinTestFramework
    pass

class ExampleTest(NaldcoinTestFramework):
    # Each functional test is a subclass of the NaldcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        NaldcoinTestFramework class so other tests can use it."""
