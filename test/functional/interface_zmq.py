...
from test_framework.test_framework import NaldcoinTestFramework, SkipTest
...
class ZMQTest (NaldcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that nald has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("naldd has not been built with zmq enabled.")
