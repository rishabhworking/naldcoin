...
class AssetTest(NaldcoinTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating NALD for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.listassets(asset="NALD*", verbose=False, count=2, start=-2)
        ...
        nald_assets = n0.listassets(asset="NALD*", verbose=False, count=2, start=-2)
        assert_equal(len(nald_assets), 2)
        assert_equal(nald_assets[0], "NALD2")
        assert_equal(nald_assets[1], "NALD3")
        self.sync_all()
