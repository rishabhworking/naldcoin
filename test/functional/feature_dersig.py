...
class BIP66Test(NaldcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # naldd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and naldd produces more specific reject
            # reasons.
