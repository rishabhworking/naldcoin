...
By default, naldd will dump mempool on shutdown and
...
class MempoolPersistTest(NaldcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give naldd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent naldd from writing mempool.dat to disk. Verify that `savemempool` fails")
