...
# TestNode: A peer we use to send messages to naldd, and store responses.
...
class CompactBlocksTest(NaldcoinTestFramework):
    ...
    # This test actually causes naldd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that naldd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for naldd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # naldd will not send blocktxn responses for blocks whose height is
