...
class TxnMallTest(NaldcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 NALD:
        ...
        # First: use raw transaction API to send 1240 NALD to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 NALD coin each
        ...
        # Node0's balance should be starting balance, plus 50NALD for another
        ...
        # Node0's total balance should be starting balance, plus 100NALD for 
