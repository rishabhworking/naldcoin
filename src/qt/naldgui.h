...
#ifndef NALD_QT_NALDGUI_H
#define NALD_QT_NALDGUI_H
...
/**
  Naldcoin GUI main class. This class represents the main window of the Naldcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NaldcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NaldcoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~NaldcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a nald wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
