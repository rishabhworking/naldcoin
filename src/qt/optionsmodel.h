...
#ifndef NALD_QT_OPTIONSMODEL_H
#define NALD_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Naldcoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // NaldcoinUnits::Unit
