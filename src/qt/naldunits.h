...
#ifndef NALD_QT_NALDUNITS_H
#define NALD_QT_NALDUNITS_H
...
/** Naldcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NaldcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NaldcoinUnits(QObject *parent);

    /** Naldcoin units.
      @note Source: https://en.nald.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NALD,
...
typedef NaldcoinUnits::Unit NaldcoinUnit;

#endif // NALD_QT_NALDUNITS_H
