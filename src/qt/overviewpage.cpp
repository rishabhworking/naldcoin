...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(NaldcoinUnits::NALD),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(NaldcoinUnits::formatWithUnit(unit, balance, false, NaldcoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(NaldcoinUnits::formatWithUnit(unit, unconfirmedBalance, false, NaldcoinUnits::separatorAlways));
    ui->labelImmature->setText(NaldcoinUnits::formatWithUnit(unit, immatureBalance, false, NaldcoinUnits::separatorAlways));
    ui->labelTotal->setText(NaldcoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, NaldcoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(NaldcoinUnits::formatWithUnit(unit, watchOnlyBalance, false, NaldcoinUnits::separatorAlways));
    ui->labelWatchPending->setText(NaldcoinUnits::formatWithUnit(unit, watchUnconfBalance, false, NaldcoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(NaldcoinUnits::formatWithUnit(unit, watchImmatureBalance, false, NaldcoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(NaldcoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, NaldcoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("NALD")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the NALD balance grid from expanding and looking terrible when asset balance is hidden
