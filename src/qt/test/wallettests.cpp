...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<NaldcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_nald-qt -platform xcb      # Linux
//     src/qt/test/test_nald-qt -platform windows  # Windows
//     src/qt/test/test_nald-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = NaldcoinUnits::formatWithUnit(unit, balance, false, NaldcoinUnits::separatorAlways);
    ...
    // Amount input
    NaldcoinAmountField* amountInput = receiveCoinsDialog.findChild<NaldcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: nald:")) != -1);
