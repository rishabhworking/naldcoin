...
#ifndef NALD_QT_GUICONSTANTS_H
#define NALD_QT_GUICONSTANTS_H
...
/* NaldcoinGUI -- Size of icons in status bar */
...
/* Naldcoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05339")
/* Naldcoin light orange */
...
/* Naldcoin shadow color - light mode */
...
/* Naldcoin label color as a string */
...
#define QAPP_ORG_NAME "Naldcoin"
#define QAPP_ORG_DOMAIN "nald.org"
#define QAPP_APP_NAME_DEFAULT "Naldcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Naldcoin-Qt-testnet"

#endif // NALD_QT_GUICONSTANTS_H
