...
#ifndef NALD_QT_GUIUTIL_H
#define NALD_QT_GUIUTIL_H
...
/** Utility functions used by the Naldcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "nald:" URI into recipient object, return true on successful parsing
