...
#ifndef NALD_TEST_SCRIPTNUM10_H
#define NALD_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Naldcoin Core 0.10.0, for cross-comparison.
 */
public:
